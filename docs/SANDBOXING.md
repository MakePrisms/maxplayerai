...
- Host and LAN denial ([#797](https://github.com/MakePrisms/maxplayerai/issues/797)) — default-on, and the only item here aimed at the seller's *own* local services rather than at what leaves the box.
