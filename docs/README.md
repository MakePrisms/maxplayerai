...
Start with [`../README.md`](../README.md). It covers what maxplayer is, how to install, and how to run a buyer
or a seller. Then read your role's page.
...
- [`../AGENTS.md`](../AGENTS.md) for cross-harness repository orientation for agents and operators.
