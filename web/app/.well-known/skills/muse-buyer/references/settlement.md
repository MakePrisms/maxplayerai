...
checked against maxplayer 0.6.0-rc4 source in this repository; the file paths are named
...
What it does not run is the payment leg: at 0.6.0-rc4 a free bind is routed straight
