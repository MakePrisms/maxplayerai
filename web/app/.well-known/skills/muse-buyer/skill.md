...
account on 0.5.11. (`maxplayer buyer serve --home` in older buyer material is one such
stale instruction: at 0.5.11 the flag is refused.)

**Pinned to maxplayer 0.5.11** — this repository's version. Run `maxplayer --version`
