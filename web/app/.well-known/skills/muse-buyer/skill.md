...
account on 0.6.0-rc3. (`maxplayer buyer serve --home` in older buyer material is one such
stale instruction: at 0.6.0-rc3 the flag is refused.)

**Pinned to maxplayer 0.6.0-rc3** — this repository's version. Run `maxplayer --version`
