 ...
 */
import { MOBEE_TAG, MAXPLAYER_TAGGED_KINDS, UNTAGGED_KINDS } from "./kinds.js";
...
export function historyStreams() {
  return [
    { name: "tagged", filter: { kinds: [...MAXPLAYER_TAGGED_KINDS], limit: PAGE_SIZE, "#t": [MOBEE_TAG] } },
...
export function liveFilters(since) {
  const tagged = { kinds: [...MAXPLAYER_TAGGED_KINDS], "#t": [MOBEE_TAG], since };
