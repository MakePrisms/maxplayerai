...

{
  ...
  services.maxplayer.reviewer = {
    ...
    # Existing reviewer key, reused as the shared private-content service identity.
    # Preserve the deployed signer at this path; do not generate or replace its key.
